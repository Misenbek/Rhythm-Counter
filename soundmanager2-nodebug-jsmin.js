...
(function(k, g) {
    function U(U, ia) {
        function V(b) {
            return c.preferFlash && D && !c.ignoreFlash && c.flash[b] !== g && c.flash[b]
        }
        function m(b) {
            return function(c) {
                var d = this._s;
        ...
        var Ja, c = this, Ka = null, h = null, W, q = navigator.userAgent, ja = k.location.href.toString(), n = document, ka, La, la, l, x = [], M = !1, N = !1, r = !1, v = !1, ma = !1, O, u, na, X, oa, E, F, G, Ma, pa, Y, qa, Z, ra, H, sa, P, ta, $, I, Na, ua, Oa, va, Pa, Q = null, wa = null, y, xa, J, aa, ba, K, p, R = !1, ya = !1, Qa, Ra, Sa, ca = 0, S = null, da, Ta = [], t = null, Ua, ea, T, B, za, Aa, Va, s, eb = Array.prototype.slice, z = !1, Ba, D, Ca, Wa, A, fa, ga = q.match(/(ipad|iphone|ipod)/i), Xa = q.match(/android/i), C = q.match(/msie/i), fb = q.match(/webkit/i), Da = q.match(/safari/i) && !q.match(/chrome/i), Ea = q.match(/opera/i), Fa = q.match(/(mobile|pre\/|xoom)/i) || ga || Xa, Ya = !ja.match(/usehtml5audio/i) && !ja.match(/sm2\-ignorebadua/i) && Da && !q.match(/silk/i) && q.match(/OS X 10_6_([3-7])/i), Ga = n.hasFocus !== g ? n.hasFocus() : null, ha = Da && (n.hasFocus === g || !n.hasFocus()), Za = !ha, $a = /(mp3|mp4|mpa|m4a|m4b)/i, Ha = n.location ? n.location.protocol.match(/http/i) : null, ab = !Ha ? "http://" : "", bb = /^\s*audio\/(?:x-)?(?:mpeg4|aac|flv|mov|mp4||m4v|m4a|m4b|mp4v|3gp|3g2)\s*(?:$|;)/i, cb = "mpeg4 aac flv mov mp4 m4v f4v m4a m4b mp4v 3gp 3g2".split(" "), gb = RegExp("\\.(" + cb.join("|") + ")(\\?.*)?$", "i");
        this.mimePattern = /^\s*audio\/(?:x-)?(?:mp(?:eg|3))\s*(?:$|;)/i;
        this.useAltURL = !Ha;
        var Ia;
        try {
            Ia = Audio !== g && (Ea && opera !== g && 10 > opera.version() ? new Audio(null) : new Audio).canPlayType !== g
        } catch (hb) {
            Ia = !1
        }
        this.hasHTML5 = Ia;
        this.setup = function(b) {
            var e = !c.url;
            b !== g && (r && t && c.ok() && (b.flashVersion !== g || b.url !== g || b.html5Test !== g)) && K(y("setupLate"));
            na(b);
            e && (P && b.url !== g) && c.beginDelayedInit();
            !P && (b.url !== g && "complete" === n.readyState) && setTimeout(H, 1);
            return c
        }
        ;
        this.supported = this.ok = function() {
            return t ? r && !v : c.useHTML5Audio && c.hasHTML5
        }
        ;
        ...
        this.createSound = function(b, e) {
            ...
            if (p(a.id, !0))
                return c.sounds[a.id];
            ea(a) ? (f = d(),
            f._setup_html5(a)) : (8 < l && null === a.isMovieStar && (a.isMovieStar = !(!a.serverURL && !(a.type && a.type.match(bb) || a.url.match(gb)))),
            a = ba(a, void 0),
            f = d(),
            8 === l ? h._createSound(a.id, a.loops || 1, a.usePolicyFile) : (h._createSound(a.id, a.url, a.usePeakData, a.useWaveformData, a.useEQData, a.isMovieStar, a.isMovieStar ? a.bufferTime : !1, a.loops || 1, a.serverURL, a.duration || null, a.autoPlay, !0, a.autoLoad, a.usePolicyFile),
        ...
        this.start = this.play = function(b, e) {
            var d = !1;
            return !r || !c.ok() ? (K("soundManager.play(): " + y(!r ? "notReady" : "notOK")),
        ...
        this.getMemoryUse = function() {
            var b = 0;
            h && 8 !== l && (b = parseInt(h._getMemoryUse(), 10));
            return b
        }
        ;
        ...
        this.canPlayMIME = function(b) {
            ...
            !e && t && (e = b && c.ok() ? !!(8 < l && b.match(bb) || b.match(c.mimePattern)) : null);
            return e
        }
        ;
        this.canPlayURL = function(b) {
            ...
            !e && t && (e = b && c.ok() ? !!b.match(c.filePattern) : null);
            return e
        }
        ;
        ...
        this.reboot = function(b, e) {
            ...
            if (h)
                try {
                    C && (wa = h.innerHTML),
                    Q = h.parentNode.removeChild(h)
                } catch (g) {}
            wa = Q = t = h = null;
            c.enabled = P = r = R = ya = M = N = v = z = c.swfLoaded = !1;
            c.soundIDs = [];
            c.sounds = {};
            if (b)
                x = [];
        ...
        ;
        Ja = function(b) {
            var e, d, a = this, f, w, db, L, k, n, m = !1, q = [], r = 0, s, v, t = null;
            d = e = null;
            this.sID = this.id = b.id;
            this.url = b.url;
            this._iO = this.instanceOptions = this.options = u(b);
            ...
            this.load = function(b) {
                ...
                if (ea(e))
                    ...
                    try {
                        ...
                        a._iO = ba(aa(e)),
                        e = a._iO,
                        8 === l ? h._load(a.id, e.url, e.stream, e.autoPlay, e.usePolicyFile) : h._load(a.id, e.url, !!e.stream, !!e.autoPlay, e.loops || 1, !!e.autoLoad, e.usePolicyFile)
                    } catch (d) {
                        I({
            ...
            this.unload = function() {
                0 !== a.readyState && (a.isHTML5 ? (L(),
                a._a && (a._a.pause(),
                za(a._a, "about:blank"),
                t = "about:blank")) : 8 === l ? h._unload(a.id, "about:blank") : h._unload(a.id),
                f());
                return a
            }
            ;
            ...
            this.start = this.play = function(b, c) {
                ...
                if (null !== d)
                    return d;
                !a.isHTML5 && (9 === l && 0 < a.position && a.position === a.duration) && (b.position = 0);
                if (a.paused && 0 <= a.position && (!a._iO.serverURL || 0 < a.position))
                    ...
                    (!a.instanceCount || a._iO.multiShotEvents || !a.isHTML5 && 8 < l && !a.getAutoPlay()) && a.instanceCount++;
                    ...
                    d.play()) : (d = h._start(a.id, a._iO.loops || 1, 9 === l ? a.position : a.position / 1E3, a._iO.multiShot || !1),
                    9 === l && !d && a._iO.onplayerror && a._iO.onplayerror.apply(a))
                }
                return a
            }
            ;
            ...
            this.pause = function(b) {
                ...
                L()) : (b || b === g) && h._pause(a.id, a._iO.multiShot);
            ...
            this.resume = function() {
                ...
                k()) : (b.isMovieStar && !b.serverURL && a.setPosition(a.position),
                h._pause(a.id, b.multiShot));
                !m && b.onplay ? (b.onplay.apply(a),
                m = !0) : b.onresume && b.onresume.apply(a);
                return a
            }
            ;
            this.togglePause = function() {
                if (0 === a.playState)
                    return a.play({
                        position: 9 === l && !a.isHTML5 ? a.position : a.position / 1E3
                    }),
                    a;
            ...
            this.clearOnPosition = function(a, b) {
                ...
                for (c = 0; c < q.length; c++)
                    if (a === q[c].position && (!b || b === q[c].method))
                        q[c].fired && r--,
                        q.splice(c, 1)
            }
            ;
            ...
            this._setup_html5 = function(b) {
                b = u(a._iO, b);
                var c = z ? Ka : a._a, e = decodeURI(b.url), d;
                z ? e === decodeURI(Ba) && (d = !0) : e === decodeURI(t) && (d = !0);
                if (c) {
                    if (c._s)
                        if (z)
                            c._s && (c._s.playState && !d) && c._s.stop();
                        else if (!z && e === decodeURI(t))
                    ...
                    a._a = b.autoLoad || b.autoPlay ? new Audio(b.url) : Ea && 10 > opera.version() ? new Audio(null) : new Audio,
                    c = a._a,
                    c._called_load = !1,
                    z && (Ka = c);
                a.isHTML5 = !0;
            ...
            w = function() {
                ...
                for (b in A)
                    A.hasOwnProperty(b) && a._a && a._a.addEventListener(b, A[b], !1);
                return !0
            }
            ;
            db = function() {
                ...
                for (b in A)
                    A.hasOwnProperty(b) && a._a && a._a.removeEventListener(b, A[b], !1)
            }
            ;
            this._onload = function(b) {
                var c = !!b || !a.isHTML5 && 8 === l && a.duration;
                a.loaded = c;
                a.readyState = c ? 3 : 2;
                a._onbufferchange(0);
            ...
            this._onfinish = function() {
                ...
                (!a.instanceCount || a._iO.multiShotEvents) && b && fa(a, function() {
                    b.apply(a)
                }))
            }
            ;
            ...
            this._whileplaying = function(b, c, e, d, f) {
                ...
                !a.isHTML5 && 8 < l && (w.usePeakData && (c !== g && c) && (a.peakData = {
                    left: c.leftPeak,
                    right: c.rightPeak
                }),
                w.useWaveformData && (e !== g && e) && (a.waveformData = {
                    left: e.split(","),
                    right: d.split(",")
                }),
                w.useEQData && (f !== g && f && f.leftEQ) && (b = f.leftEQ.split(","),
                a.eqData = b,
                a.eqData.left = b,
                f.rightEQ !== g && f.rightEQ && (a.eqData.right = f.rightEQ.split(","))));
                1 === a.playState && (!a.isHTML5 && (8 === l && !a.position && a.isBuffering) && a._onbufferchange(0),
                w.whileplaying && w.whileplaying.apply(a));
                return !0
            }
            ;
        ...
        u = function(b, e) {
            ...
            for (f in a)
                a.hasOwnProperty(f) && d[f] === g && (d[f] = "object" !== typeof a[f] || null === a[f] ? a[f] : u(d[f], a[f]));
            return d
        }
        ;
        fa = function(b, c) {
            !b.isHTML5 && 8 === l ? k.setTimeout(c, 0) : c()
        }
        ;
        X = {
            onready: 1,
        ...
        na = function(b, e) {
            var d, a = !0, f = e !== g, w = c.setupOptions;
            for (d in b)
                if (b.hasOwnProperty(d))
                    if ("object" !== typeof b[d] || null === b[d] || b[d]instanceof Array || b[d]instanceof RegExp)
                        f && X[e] !== g ? c[e][d] = b[d] : w[d] !== g ? (c.setupOptions[d] = b[d],
                        c[d] = b[d]) : X[d] === g ? (K(y(c[d] === g ? "setupUndef" : "setupError", d), 2),
                        a = !1) : c[d]instanceof Function ? c[d].apply(c, b[d]instanceof Array ? b[d] : [b[d]]) : c[d] = b[d];
                    else if (X[d] === g)
                        K(y(c[d] === g ? "setupUndef" : "setupError", d), 2),
                        a = !1;
                    else
                        return na(b[d], d);
            return a
        ...
        A = {
            ...
            loadeddata: m(function() {
                var b = this._s;
                !b._loaded && !Da && (b.duration = b._get_html5_duration())
            }),
            ...
            progress: m(function(b) {
                ...
                d && (g && d === g) && A.canplaythrough.call(this, b))
            }),
        ...
        ea = function(b) {
            return b.serverURL || b.type && V(b.type) ? !1 : b.type ? T({
                type: b.type
            }) : T({
                url: b.url
            }) || c.html5Only
        ...
        T = function(b) {
            ...
            if (b && c.html5[b] !== g)
                return c.html5[b] && !V(b);
            if (!B) {
                B = [];
                for (a in d)
                    d.hasOwnProperty(a) && (B.push(a),
                    d[a].related && (B = B.concat(d[a].related)));
                B = RegExp("\\.(" + B.join("|") + ")(\\?.*)?$", "i")
            }
            a = e ? e.toLowerCase().match(B) : null;
            !a || !a.length ? b && (e = b.indexOf(";"),
            a = (-1 !== e ? b.substr(0, e) : b).substr(6)) : a = a[1];
            a && c.html5[a] !== g ? e = c.html5[a] && !V(a) : (b = "audio/" + a,
        ...
        Va = function() {
            ...
            if (!c.useHTML5Audio || !c.hasHTML5)
                return !1;
            var e = Audio !== g ? Ea && 10 > opera.version() ? new Audio(null) : new Audio : null, d, a, f = {}, h;
            h = c.audioFormats;
            for (d in h)
                if (h.hasOwnProperty(d) && (a = "audio/" + d,
                f[d] = b(h[d].type),
                f[a] = f[d],
                d.match($a) ? (c.flash[d] = !0,
        ...
        ;
        aa = function(b) {
            8 === l && (1 < b.loops && b.stream) && (b.stream = !1);
            return b
        }
        ;
        ba = function(b, c) {
        ...
        Oa = function(b) {
            for (var c in b)
                b.hasOwnProperty(c) && "function" === typeof b[c] && (b[c] = ka)
        }
        ;
        va = function(b) {
            b === g && (b = !1);
        ...
        pa = function() {
            ...
            8 !== l && 9 !== l && (c.flashVersion = l = 8);
            var b = c.debugMode || c.debugFlash ? "_debug.swf" : ".swf";
            c.useHTML5Audio && (!c.html5Only && c.audioFormats.mp4.required && 9 > l) && (c.flashVersion = l = 9);
            c.version = c.versionNumber + (c.html5Only ? " (HTML5-only mode)" : 9 === l ? " (AS3/Flash 9)" : " (AS2/Flash 8)");
            8 < l ? (c.defaultOptions = u(c.defaultOptions, c.flash9Options),
            c.features.buffering = !0,
            c.defaultOptions = u(c.defaultOptions, c.movieStarOptions),
            c.filePatterns.flash9 = RegExp("\\.(mp3|" + cb.join("|") + ")(\\?.*)?$", "i"),
            c.features.movieStar = !0) : c.features.movieStar = !1;
            c.filePattern = c.filePatterns[8 !== l ? "flash9" : "flash8"];
            c.movieURL = (8 === l ? "soundmanager2.swf" : "soundmanager2_flash9.swf").replace(".swf", b);
        ...
        ;
        ua = function() {
            c.debugURLParam.test(ja) && (c.debugMode = !0)
        }
        ;
        p = this.getSoundById;
        J = function() {
        ...
        xa = function() {
            ...
            if (c.html5Only)
                return !1;
            c.ok() ? c.oMC && (c.oMC.className = [J(), "movieContainer", "swf_loaded" + (c.didFlashBlock ? " swf_unblocked" : "")].join(" ")) : (t && (c.oMC.className = J() + " movieContainer " + (null === b ? "swf_timedout" : "swf_error")),
            c.didFlashBlock = !0,
            E({
                type: "ontimeout",
                ignoreInit: !0,
        ...
        E = function(b) {
            ...
            if (!r && b && !b.ignoreInit || "ontimeout" === b.type && (c.ok() || v && !b.ignoreInit))
                return !1;
            var e = {
                success: b && b.ignoreInit ? c.ok() : !v
            }, d = b && b.type ? x[b.type] || [] : [], a = [], f, e = [e], g = t && !c.ok();
        ...
        F = function() {
            k.setTimeout(function() {
                c.useFlashBlock && xa();
                E();
                "function" === typeof c.onload && c.onload.apply(k);
                c.waitForWindowLoad && s.add(k, "load", F)
            }, 1)
        }
        ;
        Ca = function() {
            if (D !== g)
                return D;
            var b = !1, c = navigator, d = c.plugins, a, f = k.ActiveXObject;
            if (d && d.length)
        ...
        Ua = function() {
            ...
            if (ga && q.match(/os (1|2|3_0|3_1)/i))
                c.hasHTML5 = !1,
                c.html5Only = !0,
        ...
        Qa = function(b) {
            ...
            !Fa && c.html5PollingInterval && (null === S && 0 === ca && (S = setInterval(Sa, c.html5PollingInterval)),
            ca++))
        }
        ;
        Ra = function(b) {
            b._hasTimer && (b._hasTimer = !1,
            !Fa && c.html5PollingInterval && ca--)
        }
        ;
        Sa = function() {
            var b;
        ...
        ;
        this._externalInterfaceOK = function(b, e) {
            if (c.swfLoaded)
                return !1;
            c.swfLoaded = !0;
            ha = !1;
            Ya && Wa();
            setTimeout(la, C ? 100 : 1)
        }
        ;
        $ = function(b, e) {
            function d(a, b) {
            ...
            if (c.html5Only)
                ...
                N = M = !0,
                !1;
            var a = e || c.url, f = c.altURL || a, h = ta(), k = J(), l = null, l = n.getElementsByTagName("html")[0], m, r, p, l = l && l.dir && l.dir.match(/rtl/i);
            b = b === g ? c.id : b;
            pa();
            c.url = Pa(Ha ? a : f);
            e = c.url;
            c.wmode = !c.wmode && c.useHighPerformance ? "transparent" : c.wmode;
            if (null !== c.wmode && (q.match(/msie 8/i) || !C && !c.useHighPerformance) && navigator.platform.match(/win32|win64/i))
                Ta.push(qa.spcWmode),
                c.wmode = null;
            h = {
                name: b,
            ...
            if (h = ta())
                ...
                c.oMC.id)
                    ...
                    fb && (c.oMC.style.zIndex = 1E4);
                    if (!c.debugFlash)
                        for (p in k)
                            k.hasOwnProperty(p) && (c.oMC.style[p] = k[p]);
                    try {
        ...
        Z = function() {
            ...
            if (h || !c.url)
                return !1;
            h = c.getMovie(c.id);
            h || (Q ? (C ? c.oMC.innerHTML = wa : c.oMC.appendChild(Q),
            Q = null,
            M = !0) : $(c.id, c.url),
            h = c.getMovie(c.id));
        ...
        Ma = function() {
            ...
            setTimeout(function() {
                ...
                if (e)
                    ...
                    k.setTimeout(G, 1),
                    !1;
                !r && Za && (null === b ? c.useFlashBlock || 0 === c.flashLoadTimeout ? c.useFlashBlock && xa() : E({
                    type: "ontimeout",
                    ignoreInit: !0
                }) : 0 !== c.flashLoadTimeout && va(!0))
            }, c.flashLoadTimeout)
        }
        ;
        Y = function() {
            if (Ga || !ha)
                return s.remove(k, "focus", Y),
                !0;
            Ga = Za = !0;
            R = !1;
            G();
        ...
        O = function(b) {
            ...
            if (!c.useFlashBlock || !c.flashLoadTimeout || c.getMoviePercent())
                r = !0,
                v && (d = {
                    type: !D && t ? "NO_FLASH" : "INIT_TIMEOUT"
                });
            if (v || b)
                c.useFlashBlock && c.oMC && (c.oMC.className = J() + " " + (null === c.getMoviePercent() ? "swf_timedout" : "swf_error")),
                E({
                    type: "ontimeout",
                    error: d,
                    ignoreInit: !0
                ...
                I(d),
                e = !1;
            v || (c.waitForWindowLoad && !ma ? s.add(k, "load", F) : F());
            return e
        }
        ;
        La = function() {
        ...
        la = function() {
            if (r)
                return !1;
            if (c.html5Only)
                return r || (s.remove(k, "load", c.beginDelayedInit),
                c.enabled = !0,
                O()),
                !0;
            Z();
            try {
                ...
                Na(!0, c.flashPollingInterval || (c.useHighPerformance ? 10 : 50)),
                c.debugMode || h._disableDebug(),
                c.enabled = !0,
                c.html5Only || s.add(k, "unload", ka)
            } catch (b) {
                return I({
            ...
            O();
            s.remove(k, "load", c.beginDelayedInit);
            return !0
        }
        ;
        H = function() {
            ...
            Va();
            c.html5.usingFlash = Ua();
            t = c.html5.usingFlash;
            !D && t && (Ta.push(qa.needFlash),
            c.setup({
                flashLoadTimeout: 1
            }));
        ...
        ;
        Aa = function() {
            "complete" === n.readyState && (H(),
            n.detachEvent("onreadystatechange", Aa));
            return !0
        }
        ;
        sa = function() {
        ...
        ;
        ra = function() {
            if (Fa && (c.setupOptions.useHTML5Audio = !0,
            c.setupOptions.preferFlash = !1,
            ga || Xa && !q.match(/android\s2\.3/i)))
                ga && (c.ignoreFlash = !0),
                z = !0
        }
        ;
        ...
        s.add(k, "load", G);
        s.add(k, "load", sa);
        n.addEventListener ? n.addEventListener("DOMContentLoaded", H, !1) : n.attachEvent ? n.attachEvent("onreadystatechange", Aa) : I({
            type: "NO_DOM2_EVENTS",
            fatal: !0
        })
    }
